 ...
 * 1. Mở Google Sheet dự án.
 * 2. Chọn Tiện ích mở rộng (Extensions) -> Apps Script.
 * 3. Dán toàn bộ đoạn code này vào file Code.gs.
 * 4. (Khuyên dùng) Trong màn hình Apps Script: Chọn dịch vụ (Services) -> Thêm "Google Sheets API" (để chạy v4 tốc độ cao).
 * 5. Nhấn nút Triển khai (Deploy) -> Triển khai mới (New deployment) -> Chọn loại là Web app.
 *    - Execute as: Me (Tôi)
 *    - Who has access: Anyone (Bất kỳ ai)
 * 6. Copy URL Web app nhận được dán vào Cấu hình trên Web App.
 */
